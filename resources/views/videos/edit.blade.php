            ...
            <div id="London" class="tabcontent">
                ...
                <div class="row justify-content-center mt-4">
                    <div class="col-lg-8 mx-auto mbr-form">
                        {!! Form::open(['action' => ['VideoController@update', $video->id_video], 'method' =>'POST', 'enctype' => 'multipart/form-data']) !!}
                                <div class="form-group">
                                    {{-- {{Form::text('title', '', ['class' => 'form-control', 'placeholder' => 'Judul'])}} --}}
                                    {{Form::text('title', $video->title, ['class' => 'form-control', 'placeholder' => 'Judul'])}}
                                </div>
                                <div class="form-group">
                                    {{-- {{Form::textarea('body', '', ['id' => 'article-ckeditor', 'class' => 'form-control', 'placeholder' => 'Keterangan Video'])}} --}}
                                    {{Form::textarea('body', $video->body, ['id' => 'article-ckeditor', 'class' => 'form-control', 'placeholder' => 'Keterangan Video'])}}
                                </div>
                                <div class="form-group">
                                    {{-- {{Form::text('link', '', ['class' => 'form-control', 'placeholder' => 'Link Embed Video'])}} --}}
                                    {{Form::text('link', $video->link, ['class' => 'form-control', 'placeholder' => 'Link Embed Video'])}}
                                </div>
