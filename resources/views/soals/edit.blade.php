    ...
    <div class="container">
        ...
        <div class="row justify-content-center mt-4">
            <div class="col-lg-8 mx-auto mbr-form">
                {!! Form::open(['action' => ['SoalController@update', $soal->id_soal], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                    <div class="form-group">
                        {{Form::label('body_soal', 'Isi Soal', ['class' => 'mbr-text mbr-fonts-style display-7'])}}
                        {{Form::textarea('body_soal', $soal->body_soal, ['class' => 'form-control', 'placeholder' => 'Isi Soal Disini'])}}
                    </div>
                    <div class="form-group">
                        {{Form::label('a', 'Opsi Jawaban 1', ['class' => 'mbr-text mbr-fonts-style display-7'])}}
                        {{Form::text('a', $soal->a, ['class' => 'form-control', 'placeholder' => 'Opsi Jawaban 1 Disini'])}}
                    </div>
                    <div class="form-group">
                        {{Form::label('b', 'Opsi Jawaban 2', ['class' => 'mbr-text mbr-fonts-style display-7'])}}
                        {{Form::text('b', $soal->b, ['class' => 'form-control', 'placeholder' => 'Opsi Jawaban 2 Disini'])}}
                    </div>
                    <div class="form-group">
                        {{Form::label('c', 'Opsi Jawaban 3', ['class' => 'mbr-text mbr-fonts-style display-7'])}}
                        {{Form::text('c', $soal->c, ['class' => 'form-control', 'placeholder' => 'Opsi Jawaban 3 Disini'])}}
                    </div>
                    <div class="form-group">
                        {{Form::label('d', 'Opsi Jawaban 4', ['class' => 'mbr-text mbr-fonts-style display-7'])}}
                        {{Form::text('d', $soal->d, ['class' => 'form-control', 'placeholder' => 'Opsi Jawaban 4 Disini'])}}
                    </div>
                    ...
                    {{Form::submit('Simpan Perubahan', ['class'=>'btn btn-primary display-4', 'style'=>'float:right'])}}
                {!! Form::close() !!}
            </div>
        </div>
    </div>
