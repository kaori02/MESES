...
<head>
    ...
    <link rel="stylesheet" href="{{asset('assets-t/as-pie-progress/css/progress.min.css')}}">
        ...
        <div class="container align-center">
            <div class="row justify-content-md-center">
                <div class="mbr-white col-md-10">
                    ...
                    <p class="mbr-text pb-3 mbr-fonts-style display-5">Selamat Datang {{Auth::user()->name}} !</p>
                    @endif
                    @endif
